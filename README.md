...
## C. Hardware
We utilized Google Colaboratory (Colab), a free cloud platform for the training of our object detection models. This enabled us to take advantage of the 1 x Telsa K80 GPU on the server for 12-hour periods without the need for any hardware investment. The Telsa K80 has 2496 CUDA cores, 12GB GDDR5 VRAM. Google Colab also provides a 1x single core hyper threaded Xeon Processors @2.3Ghz (No Turbo Boost).
