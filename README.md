...
![alt text] https://github.com/asvath/mobile_robotics/blob/master/final%20results/IOU_clusters.png

B. Metric for comparing the performance of different
models
The mean average (mAP) is a metric that is used to
compare the performance of different models. It is the area
under the precision-recall curve. High precision indicates
having a high detection of true positives and a low detection
of false positives. While, high recall, indicates having a high
detection of true positives and a low detection of false
negatives.
𝑃𝑟𝑒𝑐𝑖𝑠𝑖𝑜𝑛 =
𝑇𝑃
𝑇𝑃+𝐹𝑃
